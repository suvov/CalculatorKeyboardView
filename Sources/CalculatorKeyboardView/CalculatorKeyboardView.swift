...
public extension CalculatorKeyboardView {
...
public class CalculatorKeyboardView: UIView {
...
private extension CalculatorKeyboardView {
  func configure() {
...
extension CalculatorKeyboardView: UIInputViewAudioFeedback {
